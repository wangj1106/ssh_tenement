...
<tr>
<td align="center" style="font-size:24px; color:#666"> 投诉管理</td>
</tr>
<tr>
...
<s:iterator value="list" var="c">
	<tr>
		<td align="center"><s:property value="#c.cid"/></td>
		<td align="center"><s:property value="#c.ctitle"/></td>
		<td align="center"><s:property value="#c.cdesc"/></td>
		<td align="center"><s:property value="#c.user.uname"/></td>
		<td align="center"><a href="${pageContext.request.contextPath}/complaint_delete.action?cid=<s:property value="#c.cid"/>"><img src="<%=basePath %>images/trash.gif"/></a></td>
	</tr>
</s:iterator>
</tbody>
</table>
